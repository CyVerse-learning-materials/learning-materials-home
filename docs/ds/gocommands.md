...
``` bash
curl -L -o gocmd.tar.gz https://github.com/cyverse/gocommands/releases/download/v0.4.1/gocmd-v0.4.1-linux-amd64.tar.gz && \
...
``` bash
curl -L -o gocmd.tar.gz https://github.com/cyverse/gocommands/releases/download/v0.4.1/gocmd-v0.4.1-darwin-amd64.tar.gz && \
tar zxvf gocmd.tar.gz && rm gocmd.tar.gz
```
...
``` bash
curl -L -o gocmd.tar.gz https://github.com/cyverse/gocommands/releases/download/v0.4.1/gocmd-v0.4.1-linux-arm64.tar.gz && \
tar zxvf gocmd.tar.gz && rm gocmd.tar.gz
```
