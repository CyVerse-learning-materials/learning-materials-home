...
``` bash
curl -L -o gocmd.tar.gz https://github.com/cyverse/gocommands/releases/download/v0.5.7/gocmd-v0.5.7-linux-amd64.tar.gz && \
...
``` bash
curl -L -o gocmd.tar.gz https://github.com/cyverse/gocommands/releases/download/v0.5.7/gocmd-v0.5.7-darwin-amd64.tar.gz && \
tar zxvf gocmd.tar.gz && rm gocmd.tar.gz
```
...
``` bash
curl -L -o gocmd.tar.gz https://github.com/cyverse/gocommands/releases/download/v0.5.7/gocmd-v0.5.7-linux-arm64.tar.gz && \
tar zxvf gocmd.tar.gz && rm gocmd.tar.gz
```
