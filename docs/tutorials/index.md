...
| Tutorial | Date |	Notes |
|----------|------|-------|
|[Plant Bioinformatics Vol 3 RNA-Seq Tutorial](https://cyverse-learning-materials.github.io/pbvol3_rnaseq_tutorial/)| Oct 21, 2022| An end-to-end RNA-seq analysis using the Kallisto and Sleuth, emphasizing reproducibility features of the CyVerse platforms |
